...
- (void)displayImageWithURL:(NSString *)imageURL {
    ...
    [imageView setImageWithURL:[NSURL URLWithString:imageURL] placeholderImage:[UIImage imageNamed:@"placeholder.png"] updateFrame:YES andBlock:^(void) {
    }];
...
{
    //CGSize boundsSize = self.bounds.size;
    CGSize boundsSize = CGSizeMake(320, 367);
    ...
    self.minimumZoomScale = minScale == 0 ? 0.1:minScale;

...
public class BrowseChuteActivity extends Activity implements OnApiCallComplete, OnItemClickListener {
    @SuppressWarnings("unused")
    private static final String TAG = BrowseChuteActivity.class.getSimpleName();
	...
	Intent intent = new Intent(getApplicationContext(), BrowseAssetsActivity.class);

...
public class MetaDelete extends AsyncTask<Void, Void, Boolean> {
    @SuppressWarnings("unused")
    private static final String TAG = MetaDelete.class.getSimpleName();
    private final Context context;
    private final MetaType metaType;
    private final String id;
    private final String key;

    public MetaDelete(Context context, MetaType metaType, String id, String key) {

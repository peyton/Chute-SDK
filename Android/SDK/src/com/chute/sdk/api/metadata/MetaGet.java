...
public class MetaGet extends AsyncTask<Void, Void, Boolean> {
    @SuppressWarnings("unused")
    private static final String TAG = MetaGet.class.getSimpleName();
    private final Context context;
    private final MetaType metaType;
    private final String id;
    private final String key;

    public MetaGet(Context context, MetaType metaType, String id, String key) {
